...
<header style="background-color: black;">
    ...
    <?php } ?>
    <!-- HEADER END-->
    <div class="navbar navbar-inverse set-radius-zero" style="background-color: powderblue;">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#" style="color:black; font-size:24px;4px; line-height:24px; ">
            ...
            <div class="left-div">
                <i class="fa fa-user-plus login-icon" style="background-color: blue;"></i>
        </div>
            </div>
        </div>